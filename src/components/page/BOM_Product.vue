  ...
  <div>
    ...
    <div class="container">
      <div class="handle-box">
        ...
        <el-select v-model="query.select"
                   placeholder="产品名称"
      ...
      <el-table :data="tableData"
        ...
        <el-table-column prop="productabbr"
                         label="产品简称"></el-table-column>
        <el-table-column prop="productdesc"
                         label="产品简述"></el-table-column>
        <el-table-column prop="firstcheck"
                         label="首件检测"></el-table-column>
        <el-table-column prop="qrcode"
                         label="条码"></el-table-column>
        <el-table-column prop="manageway"
                         label="管理方式"></el-table-column>
        <el-table-column prop="lotnumber"
                         label="批次"></el-table-column>
        <el-table-column prop="state"
                         label="状态"></el-table-column>
        <el-table-column prop="productunit"
                         label="产品计量单位"></el-table-column>
        <el-table-column prop="productprop"
                         label="属性"></el-table-column>
    ...
    <el-dialog title="编辑"
      ...
      <el-form ref="form"
        ...
        <el-form-item label="产品简称">
          <el-input v-model="form.productabbr"></el-input>
        </el-form-item>
        ...
        <el-form-item label="首件检测">
          <el-select v-model="form.firstcheck"
                     placeholder="请选择"
                     class="handle-select mr10">
            <el-option key="1"
                       label="是"
        ...
        <el-form-item label="管理方式">
          <el-input v-model="form.manageway"></el-input>
        </el-form-item>
        <el-form-item label="批次">
          <el-input v-model="form.lotnumber"></el-input>
        </el-form-item>
        ...
        <el-form-item label="产品计量单位">
          <el-select v-model="form.productunit"
                     placeholder="请选择">
        ...
        <el-form-item label="属性">
          <el-input v-model="form.productprop"></el-input>
        </el-form-item>
